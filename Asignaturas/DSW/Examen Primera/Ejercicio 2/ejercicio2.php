...
<body>
   ...
   $formulario = json_decode(file_get_contents('form.json'), true);
    ...
    function crearCampos(Array $formulario){
    ...
    function crearBotones(Array $formulario){
        foreach ($formulario as $botones){
    ...
    crearCampos($formulario['campos']);
    crearBotones($formulario['botones']);
    echo "</form>";
    ?>
