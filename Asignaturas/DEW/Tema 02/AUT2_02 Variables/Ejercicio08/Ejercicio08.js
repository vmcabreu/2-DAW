function ejercicio8() {
    let vector1 = Number(document.getElementById("v1"));
    let vector2 = Number(document.getElementById("v2"));
    let vector3 = Number(document.getElementById("v2"));
    let suma = vector1 + vector2 + vector3;
    ...
    if (suma > 10 && vector1 != vector2 || vector1 != vector3 || vector2 != vector3) {
